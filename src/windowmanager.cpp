...
void WindowManager::Config()
{

    auto mon = new Monitor(this->CurrentDisplay);
...
WindowManager::WindowManager(Display *display) : CurrentDisplay(display), root(DefaultRootWindow(display))
{
...
int WindowManager::OnXError(XErrorEvent *e)
{
...
void WindowManager::reparentAlreadyOpenWindows()
{
